...
from gans.general import F, criterion_GAN
from gans.logger import Logger
from gans.networks import Discriminator, print_network, weights_init, ResnetGenerator
...
class CycleGan:
    ...
    def __init__(
        ...
        print("cyc init:", cyc_weight, lambda_A, lambda_B, lr_slowdown_param)
    ...
    def update_lr(self):
        ...
        print(new_lr, self.lr, self.lr_slowdown_param)
        self.old_lr = self.lr
        self.lr = new_lr
