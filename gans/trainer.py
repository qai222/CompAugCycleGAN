...
from gans.cyc import CycleGan
from gans.evaluation import eval_for_dist, eval_for_mindist, baseline_random, baseline_identity, eval_for_ratio
from settings import *
from utils import save_yml, create_dir, load_yml, timestamp, plot_violin, save_pkl
...
class Trainer:
    ...
    def train(self, load_pre_trained=False, save_freq=500, eval_after_train=True):
        ...
        if eval_after_train:
            ...
            print("baseline:", np.mean(distributions[1]))
            print("prior:", np.mean(distributions[0]))
