...
from cacgan.data.dataset import DimDataset, FormulaDataset
from cacgan.gans import Trainer
from cacgan.utils import SEED, dim_color_rule, seed_rng, load_pkl, MnM
"""
rf predict dimensionality of generated compositions
`umap` depends on `numba==0.55.1` which requires numpy<1.22,>=1.18, if you have a newer version, run:
...
trainer_dir = os.path.abspath("../../tuned/20211013T133839-2/")
...
rf_opt = load("../tune_models/models/opt-rf.pkl")
