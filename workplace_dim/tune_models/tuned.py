...
from data.dataset import DimDataset
...
opt_knn = load("opt-knn.pkl")
opt_lr = load("opt-lr.pkl")
opt_rf = load("opt-rf.pkl")
...
if __name__ == '__main__':
    ...
    #     dump(opt.best_estimator_, "tuned-{}.pkl".format(name))
    #
    # data = np.array([cv_scores, test_scores])
    # print(data)
    ...
    plt.savefig("tuned.eps", dpi=600, bbox_inches='tight', pil_kwargs={"compression": "tiff_lzw"})
